...
## Studio surface
D1 adds canonical Album/EP/Collection listing, explicit draft creation with immutable ID, metadata/status/palette editing, ordered `album.trackIds`, transactional cross-Album moves, cover preview, explicit palette application, sequential cover+thumbnail upload and guarded asset deletion. Whole-Album deletion is intentionally absent.
