...
4. [`../changelogs/CHANGELOG-PHASE7-C-BUILD71.md`](../changelogs/CHANGELOG-PHASE7-C-BUILD71.md) — current accepted Build71 / TM5.22 REAL USER PASS record.
5. [`PHASE-7-C-GUIDED-ACTIONS-CONTRACT.md`](PHASE-7-C-GUIDED-ACTIONS-CONTRACT.md) — Phase 7-C contract and runtime gates.
6. [`STUDIO-FOUNDATION-REGRESSION-REPAIR-CLOSEOUT-REAL-USER-PASS.md`](STUDIO-FOUNDATION-REGRESSION-REPAIR-CLOSEOUT-REAL-USER-PASS.md) — accepted Build67 / TM5.21 repair closeout.
...
Build71 is the accepted cumulative runtime. Builds69/70 remain historical candidate lineage and are not retroactively relabeled REAL USER PASS.
