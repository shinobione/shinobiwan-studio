...
const shellCopy: Record<Exclude<StudioRoute, 'catalog' | 'albums' | 'workflow'>, { eyebrow: string; title: string; body: string }> = {
  dashboard: {
    ...
    body: 'Studio keeps canonical Track, Album, Lyrics and SonicTrace state visible while Phase 7 turns those existing sources into explicit next actions and verified continuation receipts without replacing their authorities.',
  },
  intelligence: {
