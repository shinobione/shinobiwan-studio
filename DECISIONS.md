...
> **Local Build107 overlay — 2026-09-13:** Local Build107 extraction decision: SonicTrace owns the only editable numerical kernel (normalization, dot product, powerComponent). Studio consumes a generated byte-pinned offline distribution. Surrounding catalog policies remain application-owned. Final provenance pins the actual SonicTrace module js/catalog-projection-kernel.mjs at commit 70b0bf277a01f3817dd2db71c91233a8fe91debf; Studio remains uncommitted and the kernel digest is unchanged. See [local implementation receipt](docs/BUILD107-LOCAL-IMPLEMENTATION.md).
