...
assert.ok(['0.19.3', '0.19.4', '0.19.5', '0.19.6', '0.19.7', '0.19.8', '0.19.9'].includes(pkg.version), 'Build67 guard only accepts the validated v0.19.3-v0.19.9 Studio successor line.');
...
console.log(`Studio ${pkg.version} Build67 guard passed through the bounded v0.19.9 Phase9 successor: Lyrics TXT remains the permanent top-level source control before sync.`);
