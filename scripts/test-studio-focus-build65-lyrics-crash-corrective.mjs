...
console.log(`Studio ${pkg.version} Build65 guard passed through Build109: missing-lyrics presentation remains idempotent and AssetsManager owns guarded TXT upload.`);
