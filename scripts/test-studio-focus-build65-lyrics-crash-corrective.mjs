...
assert.ok(['0.19.3', '0.19.4', '0.19.5'].includes(pkg.version), 'Build65 guard only accepts the validated v0.19.3/v0.19.4/v0.19.5 Studio successor line.');
...
console.log(`Studio ${pkg.version} Build65 guard passed through the bounded v0.19.5 Phase9 successor: missing-lyrics presentation remains idempotent and AssetsManager owns guarded TXT upload.`);
