...
console.log(`Studio ${pkg.version} Build65 guard passed through Build108: missing-lyrics presentation remains idempotent and AssetsManager owns guarded TXT upload.`);
