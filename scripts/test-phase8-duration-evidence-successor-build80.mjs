...
assert.ok(trackMetadataApi.includes("const DURATION_EVIDENCE_BRIDGES = new Set(['5.22/1.12', '5.23/1.13']);"), 'Build92 save seam must preserve the same bounded duration-evidence bridge pairs');
...
console.log('Build80 duration-evidence successor compatibility guard passed through Build92: TM5.22/1.12 and TM5.23/1.13 remain bounded-compatible across validation + resilient save, unknown pairs remain locked, and duration stays derived canonical evidence.');
