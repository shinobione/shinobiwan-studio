...
assert.ok(['0.19.26', '0.19.27', '0.19.28', '0.19.29'].includes(pkg.version), 'Build104 guard accepts Build104 and bounded Build105/Build106/Build107 successors.');
...
if (['0.19.27', '0.19.28', '0.19.29'].includes(pkg.version)) {
