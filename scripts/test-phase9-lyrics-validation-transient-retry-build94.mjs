...
assert.ok(['0.19.16', '0.19.17', '0.19.18', '0.19.19', '0.19.20', '0.19.21'].includes(pkg.version), 'Build94 guard accepts Build94 and its bounded Build95/Build96/Build97/Build98 successors.');
if (['0.19.18', '0.19.19', '0.19.20', '0.19.21'].includes(pkg.version)) assert.ok(release.includes('build95AncestryMarker'), 'Build96+ must preserve accepted Build95 ancestry while inheriting Build94 validation truth.');
if (['0.19.19', '0.19.20', '0.19.21'].includes(pkg.version)) assert.ok(release.includes('build96AncestryMarker'), 'Build97+ must preserve accepted Build96 ancestry while inheriting Build94 validation truth.');
if (['0.19.20', '0.19.21'].includes(pkg.version)) assert.ok(release.includes('build97AncestryMarker'), 'Build98+ must preserve Build97 ancestry while inheriting Build94 validation truth.');
if (pkg.version === '0.19.21') assert.ok(release.includes('build98AncestryMarker'), 'Build99 must preserve accepted Build98 ancestry while inheriting Build94 validation truth.');
