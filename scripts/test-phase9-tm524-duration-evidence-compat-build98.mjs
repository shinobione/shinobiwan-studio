...
for (let build = 99; build <= Math.min(currentBuild - 1, 110); build += 1) {
...
console.log(`Build98 TM5.24/bridge1.14 compatibility corrective guard passed through Build${currentBuild}: duration evidence stays explicitly bounded, Build97 create truth remains intact, and writes retain zero automatic retries.`);
