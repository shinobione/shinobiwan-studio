...
assert.ok(['0.19.20', '0.19.21', '0.19.22', '0.19.23', '0.19.24', '0.19.25', '0.19.26', '0.19.27', '0.19.28', '0.19.29', '0.19.30', '0.19.31'].includes(pkg.version), 'Build98 guard accepts Build98 and bounded successors through Build109.');
...
if (['0.19.24', '0.19.25', '0.19.26', '0.19.27', '0.19.28', '0.19.29', '0.19.30', '0.19.31'].includes(pkg.version)) assert.ok(release.includes('build101AncestryMarker'), 'Build102+ must preserve Build101 candidate ancestry while retaining the stronger Track asset verification boundary.');
...
console.log('Build98 TM5.24/bridge1.14 compatibility corrective guard passed through Build109: duration evidence stays explicitly bounded, Build97 create truth remains intact, and writes retain zero automatic retries.');
