...
assert.match(release, /build:\s*(?:69|70|71|72|73|82|83|84|85|86|87|88|89|90|91|92|93|94|95)/);
assert.match(
  release,
...
if (/build:\s*(?:82|83|84|85|86|87|88|89|90|91|92|93|94|95)/.test(release)) {
...
console.log('Phase 7-C Slice 1 lineage through Build73 remains protected through bounded Build82-Build95 Phase9 successor compatibility; Build95 preserves Build94 accepted ancestry while converging the daily Albums UI onto accepted resilient mutation services.');