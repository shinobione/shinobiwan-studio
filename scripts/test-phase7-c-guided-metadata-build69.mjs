...
assert.match(release, /build:\s*(69|70|71|72|73)/);
assert.match(release, /codename:\s*'studio-focus-slice4-(phase7c-slice1-guided-metadata|phase7c-presmoke-publication-intake-fix|phase7c-duration-evidence-corrective|phase7c-slice2-guided-core-media|phase7c-slice2-status-truth-corrective)'/);
