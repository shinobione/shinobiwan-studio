...
assert.match(release, /version:\s*'0\.20\.0'/);
assert.match(release, /build:\s*69/);
assert.match(release, /codename:\s*'phase7c-slice1-guided-metadata'/);
...
console.log('Build 69 Phase 7-C guided metadata check passed.');
