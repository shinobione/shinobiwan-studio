...
const slice3OrLaterSuccessor = /^0\.(?:18|19)\.\d+$/.test(version) && build > 57 && codename.startsWith('studio-focus-');
assert.ok(build57 || slice3OrLaterSuccessor, `Build 57 Track Workshop ancestry must survive authorized Studio Focus successors, got ${version} Build ${build} / ${codename}.`);
