...
assert.match(release, /build:\s*(?:74|75|76|77|78|79)/);
assert.ok(
...
if (/build:\s*(?:75|76|77|78|79)/.test(release)) assert.ok(release.includes('build74AncestryMarker'));
...
console.log('Phase 8 Build74 content-health truth checks passed through Build79.');
