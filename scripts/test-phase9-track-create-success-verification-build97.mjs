...
assert.ok(['0.19.19', '0.19.20', '0.19.21', '0.19.22', '0.19.23'].includes(pkg.version), 'Build97 guard accepts Build97 and its bounded Build98/Build99 successors.');
...
if (['0.19.20', '0.19.21', '0.19.22', '0.19.23'].includes(pkg.version)) assert.ok(release.includes('build97AncestryMarker'), 'Build98+ must preserve Build97 Track create ancestry.');
if (['0.19.21', '0.19.22', '0.19.23'].includes(pkg.version)) assert.ok(release.includes('build98AncestryMarker'), 'Build99 must preserve accepted Build98 ancestry while inheriting Build97 Track create truth.');
