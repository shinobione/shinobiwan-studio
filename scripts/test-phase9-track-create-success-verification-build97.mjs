...
assert.ok(['0.19.19', '0.19.20', '0.19.21', '0.19.22', '0.19.23', '0.19.24', '0.19.25'].includes(pkg.version), 'Build97 guard accepts Build97 and bounded successors through Build103.');
...
if (['0.19.20', '0.19.21', '0.19.22', '0.19.23', '0.19.24', '0.19.25'].includes(pkg.version)) assert.ok(release.includes('build97AncestryMarker'), 'Build98+ must preserve Build97 Track create ancestry.');
if (['0.19.21', '0.19.22', '0.19.23', '0.19.24', '0.19.25'].includes(pkg.version)) assert.ok(release.includes('build98AncestryMarker'), 'Build99+ must preserve accepted Build98 ancestry while inheriting Build97 Track create truth.');
...
if (['0.19.23', '0.19.24', '0.19.25'].includes(pkg.version)) assert.ok(release.includes('build100AncestryMarker'), 'Build101+ must preserve Build100 ancestry.');
...
if (['0.19.23', '0.19.24', '0.19.25'].includes(pkg.version)) {
  ...
  if (['0.19.24', '0.19.25'].includes(pkg.version)) {
...
console.log('Phase9 Build97 Track create success-verification guard passed through Build103: normal success still proves the complete server-normalized create manifest while Track asset fingerprint verification inherits the bounded ETag representation corrective.');
