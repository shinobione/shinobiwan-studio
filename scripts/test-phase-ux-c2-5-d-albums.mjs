...
for (const required of ['Canonical releases, finally managed in Studio.','+ New Album / EP','Create canonical draft','album.trackIds','Save tracklist','Move to…','Upload cover + thumbnail','Apply palette to metadata form','C2.5-D boundary','C2.5-E/F']) assert.ok(albumUi.includes(required), `Album Manager UI missing: ${required}`);
...
console.log('Studio 0.11.0 Build 32 exposes guarded canonical Album Management through Track Manager v5.17 without direct R2 access, migration, whole-Album deletion or Phase 7 work.');
