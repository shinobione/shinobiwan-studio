...
if (['0.19.24', '0.19.25', '0.19.26', '0.19.27', '0.19.28', '0.19.29'].includes(pkg.version)) assert.ok(release.includes('build101AncestryMarker'), 'Build102+ must preserve rejected Build101 candidate ancestry.');
...
console.log(`Studio ${pkg.version} Build66 guard passed through Build107: asset roles, Lyrics source continuity and write ownership remain intact.`);
