...
console.log(`Studio ${pkg.version} Build66 guard passed through Build109: asset roles, Lyrics source continuity and write ownership remain intact.`);
