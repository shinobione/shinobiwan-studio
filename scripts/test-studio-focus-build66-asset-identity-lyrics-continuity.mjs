...
if (['0.19.21', '0.19.22'].includes(pkg.version)) assert.ok(read('src/release.ts').includes('build98AncestryMarker'), 'Build99 must preserve accepted Build98 Phase9 ancestry.');
const release = read('src/release.ts');
const lyrics = read('src/components/LyricsEditorPanel.tsx');
const css = read('src/studio-focus-build66-assets.css');
const main = read('src/main.tsx');

assert.ok(['0.19.3', '0.19.4', '0.19.5', '0.19.6', '0.19.7', '0.19.8', '0.19.9', '0.19.10', '0.19.11', '0.19.12', '0.19.13', '0.19.14', '0.19.15', '0.19.16', '0.19.17', '0.19.18', '0.19.19', '0.19.20', '0.19.21', '0.19.22'].includes(pkg.version), 'Build66 guard only accepts the validated v0.19.3-v0.19.21 Studio successor line.');
