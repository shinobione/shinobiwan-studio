...
assert.ok(['0.19.18', '0.19.19', '0.19.20', '0.19.21'].includes(pkg.version), 'Build96 guard accepts Build96 and its bounded Build97/Build98 successors.');
...
if (['0.19.19', '0.19.20', '0.19.21'].includes(pkg.version)) {
...
if (['0.19.20', '0.19.21'].includes(pkg.version)) assert.ok(release.includes('build97AncestryMarker'), 'Build98+ must preserve Build97 ancestry while inheriting Build96 Album create truth.');
if (pkg.version === '0.19.21') assert.ok(release.includes('build98AncestryMarker'), 'Build99 must preserve accepted Build98 ancestry while inheriting Build96 Album create truth.');
