...
assert.ok(['0.19.3', '0.19.4', '0.19.5', '0.19.6', '0.19.7', '0.19.8', '0.19.9'].includes(pkg.version), 'Build64 guard only accepts the validated v0.19.3-v0.19.9 Studio successor line.');
...
console.log(`Studio ${pkg.version} Build64 foundation regression repair contract remains protected through the bounded v0.19.9 Phase9 successor.`);
