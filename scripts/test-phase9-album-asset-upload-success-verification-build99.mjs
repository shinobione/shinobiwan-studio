...
assert.ok(['0.19.21', '0.19.22', '0.19.23', '0.19.24', '0.19.25', '0.19.26', '0.19.27'].includes(pkg.version), 'Build99 guard accepts Build99 and bounded successors through Build105.');
...
if (['0.19.22', '0.19.23', '0.19.24', '0.19.25', '0.19.26', '0.19.27'].includes(pkg.version)) {
...
if (['0.19.23', '0.19.24', '0.19.25', '0.19.26', '0.19.27'].includes(pkg.version)) assert.ok(release.includes('build100AncestryMarker'), 'Build101+ must preserve accepted Build100 ancestry.');
...
console.log('Phase9 Build99 Album asset upload success-verification guard passed through Build105: normal success proves response revision + requested slot/path + canonical presence and available server fingerprint fields, while exact selected-byte and lost-response causality remain explicitly out of scope with zero automatic retries.');
